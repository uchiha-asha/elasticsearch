...
public class RestClearIndicesStatsAction extends RestIndicesStatsAction {

    @Override
    public List<Route> routes() {
        return unmodifiableList(asList(
            new Route(PUT, "/_stats/_clear"),
            new Route(PUT, "/_stats/_clear/{metrics}"),
            new Route(PUT, "/{index}/_stats/_clear"),
            new Route(PUT, "/{index}/_stats/_clear/{metric}")));
    }
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request, final NodeClient client) throws IOException {
        ...
        // It is a replica of super.prepareRequest() for now.
    ...
    public String getName() {
        return "clear_indices_stats_action";
    }
}
